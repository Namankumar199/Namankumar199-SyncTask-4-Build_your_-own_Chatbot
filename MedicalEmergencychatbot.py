...
def get_bot_response(user_input):
    ...
    bot_responses = {
        ...
        "hai": ["Hello! What's your emergency?", "Hi there! What's your emergency?", "Hey! Whats your emergency?", "Greetings! Whats your emergency?"],
        ...
        "stop": ["Stay safe and take care!", "Wishing you good health! Goodbye!"],
        "end": ["Stay safe and take care!", "Wishing you good health! Goodbye!"],
        "exit": ["Stay safe and take care!", "Wishing you good health! Goodbye!"],
        ...
        "i am having a headache": ["Head pain could be a symptom of a mental stress and overthinking. Please call contact to near by doctor ", "If you are experiencing haevy headache, please visit to near by hospital as soon as possible."],
...
chat_log = tk.Text(chat_frame, wrap="word", bg="lightblue", font=("Arial", 13))
chat_log.pack(expand=True, fill="both")

input_frame = ttk.Frame(root)
input_frame.pack(pady=10)

user_entry = ttk.Entry(input_frame, width=60, font=("Arial", 13))
